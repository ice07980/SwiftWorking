...
var levelDifficuties = ["Easy", "Moderate", "Veteran", "Nightmare"]

// Count and isEmpty
levelDifficuties.count
levelDifficuties.isEmpty

// Accessing array values
var easyDifficulty = levelDifficuties[0]

for difficulty in levelDifficuties{
    print(difficulty)
}

for (index, difficulty) in levelDifficuties.enumerated(){
